...
| 5 | Code RAG Agent — ChromaDB + NVIDIA NIM embeddings | ✅ Production |
...
- On incremental runs, detects embedding-dimension mismatch from a prior model and rebuilds the ChromaDB collection with a full re-embed.
